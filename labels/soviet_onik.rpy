    ...
    play music msys01
    show rena se wa_a1 at central with m1
    ...
    show satoko se bik_a1 at sprava with right
    ...
    show mion se wink_a2 at central with dissolve_02
    ...
    nvl clear
    show mion se def_b1 at sleva behind rena with left_03
    ...
    show rika se wa_a1 at central behind rena with dissolve_04
    ...
    hide rika
    with dissolve_04
    show satoko se wa_a1 at sleva with m1_03
    a_s "\"Какая разница, я хочу знать, как дальше пойдёт рассказ!\""
    nvl clear
    stop music fadeout 1.0
    play sound wa_013
    scene white
    scene bg 163 with fade_050
    ...
    show mion se wa_a2 at sprava with left_03
    a_m "\"Вы тооож!!!"
    ...
    show rena se nande_a1 at sprava with left_03
    a_r "\"...Эх,"
    extend " жалко."
    ...
    show ooishi si wa_a1 at sleva behind rika with left_03
    ...
    show rena se nande_a1 at central with fastup
    ...
    show mion se wink_b2 at sleva behind ooishi with left_03
    ...
    hide tomi
    with dissolve_04
    show rena se nande_a1 at central with left_03
    ...
    show ooishi si def_a1 behind tomi with dissolve_02
    ...
    show rena se def_a1 at central behind tomi with dissolve_02
    a_r "\"Например?"
    ...
    show mion se def_b1 at sprava behind rena with right_03
    ...
    show satoko se aku_a1 at sleva behind tomi with left_03
    ...
    nvl clear
    show rika se de_a1 at sleva behind mion with left_03
    ...
    hide ooishi with left_03
    show mion se maji_a1 at sprava with right_03
    ...
    show mion se def_b1 at sprava with dissolve_02
    a_m "\"Ох, извини."
    ...
    hide mion with right_03
    show tomi si_wa at sleva behind satoko with left_03
    ...
    nvl clear
    show rena se nande_a1 at central behind satoko with dissolve_04
    ...
    hide rena with right_30
    show mion se tk_a1 at sleva behind tomi with left_03
    a_m "\"Ну, блин!"
    ...
    show rena se wa_b1 at central behind satoko with dissolve_04
    a_r "\"О, правда ведь!"
    ...
    hide ooishi with right_03
    show mion se wa_a1 at sleva with left_03
    play sound wa_010
    ...
    show rena se def_a1 at sleva with fastup
    a_r "\"Так."
    ...
    hide ooishi with dissolve_04
    show rika se de_a1 at sleva behind tomi with left_03
    ...
    show mion se def_b1 at central behind rena with dissolve_02
    ...
    nvl clear
    scene bg 163 with right_03
    show ooishi si wa_a1 at sprava with right_03
    a_o "\"Ох, надо же."
    ...
    show rika se de_a1 at sleva with dissolve_02
    ...
    show tomi si_wa at sleva behind mion with left_03
    ...
    show satoko se aku_a1 at central with dissolve_02
    ...
    $ renpy.pause(2.0)
    stop ambient fadeout 1.0
    scene bg 011 with Dissolve(1.0)
    a_r "\"Алло, Кейти-кун?"
    extend " Рэна звонит!"
